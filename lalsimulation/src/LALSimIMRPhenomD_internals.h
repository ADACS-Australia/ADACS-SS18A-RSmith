...
UNUSED double FinalSpin0815(double eta, double chi1, double chi2);
...
IMRPhenomDPhaseCoefficients* ComputeIMRPhenomDPhaseCoefficients(double eta, double chi1, double chi2, double finspin, LALDict *extraParams);
